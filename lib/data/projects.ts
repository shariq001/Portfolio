...
export const projects: Project[] = [
  {
    ...
    techPills: ['SDD', 'Spec-Kit Plus', 'Antigravity CLI'],
  ...
  },
  {
    ...
    techPills: ['Python', 'LLMs', 'LinkedIn API', 'Workspace API'],
    liveUrl: null,
    repoUrl: null,
    visibility: 'private'
  },
  {
    ...
    techPills: ['Next.js', 'Tailwind CSS', 'Vercel'],
  ...
  },
  {
    ...
    techPills: ['React', 'Next.js', 'Tailwind CSS'],
  ...
  },
  {
    ...
    techPills: ['Python', 'LLMs', 'Streamlit'],
    liveUrl: null,
  ...
  },
  {
    ...
    techPills: ['Python', 'REST API', 'In-Memory'],
    liveUrl: null,
