  ...
  return (
    <section id="contact" className="min-h-screen flex flex-col justify-center px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto py-20 relative">
      ...
      <div className="text-center md:text-left mb-16 relative z-10">
        ...
        <div className="inline-flex items-center gap-3 px-5 py-2.5 rounded-full bg-green-500/10 border border-green-500/20 text-green-400 font-mono text-sm animate-fade-up" style={{ animationDelay: '0.1s' }}>
        ...
        <div className="flex flex-col animate-fade-up h-full" style={{ animationDelay: '0.4s' }}>
          <div className="bg-white/5 border border-white/10 rounded-[2rem] p-8 backdrop-blur-md h-full flex flex-col justify-center shadow-xl">
            ...
            <div className="flex flex-col gap-4">
              {/* Email Link */}
              <a href="mailto:shariqfazal123@gmail.com" className="flex items-center gap-5 bg-surface/50 border border-white/5 rounded-2xl p-4 hover:bg-white/10 hover:border-primary/50 transition-all duration-300 group hover:-translate-x-2">
                <div className="w-12 h-12 rounded-full bg-white/5 border border-white/10 flex items-center justify-center group-hover:bg-primary group-hover:text-surface group-hover:border-primary transition-all duration-300 text-white group-hover:scale-110 shadow-lg group-hover:shadow-[0_0_15px_rgba(0,255,255,0.4)]">
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path></svg>
                </div>
                <div>
                  <div className="text-xs font-semibold uppercase tracking-wider text-muted mb-1">Email</div>
                  <div className="text-white font-mono text-sm md:text-base font-bold group-hover:text-primary transition-colors">shariqfazal123@gmail.com</div>
                </div>
              </a>

              {/* Phone Link */}
              <a href="tel:+923182965978" className="flex items-center gap-5 bg-surface/50 border border-white/5 rounded-2xl p-4 hover:bg-white/10 hover:border-primary/50 transition-all duration-300 group hover:-translate-x-2">
                <div className="w-12 h-12 rounded-full bg-white/5 border border-white/10 flex items-center justify-center group-hover:bg-primary group-hover:text-surface group-hover:border-primary transition-all duration-300 text-white group-hover:scale-110 shadow-lg group-hover:shadow-[0_0_15px_rgba(0,255,255,0.4)]">
                ...
                <div>
                  <div className="text-xs font-semibold uppercase tracking-wider text-muted mb-1">Phone</div>
                  <div className="text-white font-mono text-sm md:text-base font-bold group-hover:text-primary transition-colors">+92 318 2965978</div>
                </div>
              </a>

              {/* LinkedIn Link */}
              <a href="https://linkedin.com/in/muhammad---shariq" target="_blank" rel="noopener noreferrer" className="flex items-center gap-5 bg-surface/50 border border-white/5 rounded-2xl p-4 hover:bg-white/10 hover:border-primary/50 transition-all duration-300 group hover:-translate-x-2">
                <div className="w-12 h-12 rounded-full bg-white/5 border border-white/10 flex items-center justify-center group-hover:bg-primary group-hover:text-surface group-hover:border-primary transition-all duration-300 text-white group-hover:scale-110 shadow-lg group-hover:shadow-[0_0_15px_rgba(0,255,255,0.4)]">
                ...
                <div>
                  <div className="text-xs font-semibold uppercase tracking-wider text-muted mb-1">LinkedIn</div>
                  <div className="text-white font-mono text-sm md:text-base font-bold group-hover:text-primary transition-colors">/muhammad---shariq</div>
                </div>
              </a>

              {/* GitHub Link */}
              <a href="https://github.com/shariq001" target="_blank" rel="noopener noreferrer" className="flex items-center gap-5 bg-surface/50 border border-white/5 rounded-2xl p-4 hover:bg-white/10 hover:border-primary/50 transition-all duration-300 group hover:-translate-x-2">
                <div className="w-12 h-12 rounded-full bg-white/5 border border-white/10 flex items-center justify-center group-hover:bg-primary group-hover:text-surface group-hover:border-primary transition-all duration-300 text-white group-hover:scale-110 shadow-lg group-hover:shadow-[0_0_15px_rgba(0,255,255,0.4)]">
                ...
                <div>
                  <div className="text-xs font-semibold uppercase tracking-wider text-muted mb-1">GitHub</div>
                  <div className="text-white font-mono text-sm md:text-base font-bold group-hover:text-primary transition-colors">@shariq001</div>
                </div>
              </a>
            </div>
          </div>
