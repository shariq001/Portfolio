    ...
    <section id="hero" className="min-h-screen flex items-center px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto relative overflow-hidden">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center relative z-10 w-full mt-16 lg:mt-0">
        ...
        <div className="flex flex-col justify-center">
          ...
          >
            <h2 className="text-xl md:text-2xl font-mono text-primary animate-typing overflow-hidden whitespace-nowrap border-r-4 border-primary">
          ...
          >
            ...
            <a href="/Muhammad_Shariq_Resume.pdf" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 border border-white/10 bg-white/5 text-white font-semibold px-6 py-4 rounded-lg hover:bg-white/10 hover:border-white/30 transition-all hover:scale-105 active:scale-95 backdrop-blur-md">
